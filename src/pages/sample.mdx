...
<PageLayout title={SITE.title} description={SITE.description}>
    ...
    <MapLibre
        ...
        layers={[
            { url:'https://data.cityofnewyork.us/resource/43nn-pn8j.geojson?cuisine_description=Pizza&$limit=10000', layerType:'circle', id:'pizza', paint:{'circle-color':'#ff0000','circle-radius':5} },
        ]}
    />
